...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/07 12:42:43 by vkhut             #+#    #+#             */
/*   Updated: 2025/05/07 13:33:25 by vkhut            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_exec_child(t_node *node)
{
	...
	if (!fork_pid)
	{
		...
		path_status = ft_get_path((node -> expand_args)[0]);
...
int	ft_exec_simple_cmd(t_node *node, bool piped)
{
	...
	else if (ft_is_builtin((node -> expand_args)[0]))
	{
		...
		tmp_status = ft_exec_builtin(node -> expand_args);
